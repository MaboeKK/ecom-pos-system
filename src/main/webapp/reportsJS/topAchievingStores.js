$(document).ready(function () {
    ...
    if ($('#barChart').length && $('#pieChart').length) {
        // Bar Chart for Top Achieving Stores
        var monthlyBarChartCtx = document.getElementById('barChart').getContext('2d');
        new Chart(monthlyBarChartCtx, {
            type: 'bar',
            data: {
                labels: topAchievingLabels, // Array of labels
                datasets: [{
                    label: 'Total Sales',
                    data: topAchievingData, // Array of data points
        ...
        // Pie Chart for Top Achieving Stores
